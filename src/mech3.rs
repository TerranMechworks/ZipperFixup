...
const DRAW_LINE_FN_PTR: *mut DrawLineFn = 0x008008c0 as _;
const DRAW_LINE_ADDR: *const DrawLineFn = 0x00563b80 as _;

type DrawDashedLineFn = extern "fastcall" fn(*mut u16, i32, i32, i32, i32, i16, i32);
const DRAW_DASHED_LINE_FN_PTR: *mut DrawDashedLineFn = 0x008008c4 as _;
const DRAW_DASHED_LINE_ADDR: *const DrawDashedLineFn = 0x00563c50 as _;
...
extern "fastcall" fn draw_line(
    ...
    let func = unsafe { *DRAW_LINE_ADDR };
...
extern "fastcall" fn draw_dashed_line(
    ...
    crate::dbg!("draw_dashed_line");
    let (x1, y1) = clamp_to_screen_space(x1, y1);
    let (x2, y2) = clamp_to_screen_space(x2, y2);

    let func = unsafe { *DRAW_DASHED_LINE_ADDR };
